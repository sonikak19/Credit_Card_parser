...
mode = st.radio("Choose Mode:", ["Upload Statement", "Generate Fake Statements"])
...
if mode == "Upload Statement":
    ...
    if st.button("🚀 Generate Fake Statements"):
        os.makedirs("statements", exist_ok=True)
        generate_statements()
        st.success("✅ Fake statements generated in the 'statements/' folder.")
